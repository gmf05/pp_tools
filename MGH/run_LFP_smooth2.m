...
for response = 1
  ...
  try 
    ...
    m
    m.X = [];
%     m.plot(d,p); plot2svg(['MG49_Seizure45_smooth2_c' num2str(response)]); pause(0.01); clf;
    m.plot(d,p); pause(); saveas(gcf,['MG49_Seizure45_LFP_pp_smooth2_c' num2str(response)],'fig'); 
  end
...
save -v7.3 MG49_Seizure45_LFP_pp_smooth2 ms p
