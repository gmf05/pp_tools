function data = get_spikes2(patient_name,seizure_name,data_type,thresh1,dT1,thresh2,dT2,dT3)
...
%   data_name = [patient_name '_' seizure_name '_' data_type '_' num2str(thresh1) '_' num2str(dT1) '_' num2str(thresh2) '_' num2str(dT2)];
  data_name = [patient_name '_' seizure_name '_' data_type '_' num2str(thresh1) '_' num2str(dT1) '_' num2str(thresh2) '_' num2str(dT2) '_' num2str(dT3)];
  data_name0 = [patient_name ' ' seizure_name ' ' data_type ' @ thresh=' num2str(thresh1) ',' num2str(dT1) ',' num2str(thresh2) ',' num2str(dT2) ',' num2str(dT3)];
...
%         spkind = spikefindB(-zscore(d(n,:)),thresh1,dT1,thresh2,dT2);
        spkind = spikefindC(-zscore(d(n,:)),thresh1,dT1,thresh2,dT2,dT3);
        spikes{n} = t(spkind);
...
function spikes = spikefindC(x,thresh1,dT1,thresh2,dT2,dT3)
spikes=[];
T = length(x);
T0 = T-dT2;
t=dT1+1;
